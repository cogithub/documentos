...
CREATE TABLE `cambio` (
  ...
  `codigomon` varchar(3) DEFAULT ' ',
  `nombre` varchar(30) DEFAULT ' ',
  `fecha` date NOT NULL DEFAULT '0000-00-00',
  `cambio` double(20,7) NOT NULL DEFAULT '0.0000000'
...
INSERT INTO `cambio` VALUES ('SOLZUL','001','000','Bolívar                       ','0000-00-00',0.0000000);
...
-- Dump completed on 2014-07-25 10:38:40
