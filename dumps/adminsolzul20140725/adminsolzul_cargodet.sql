...
--
-- Table structure for table `cargodet`
--

DROP TABLE IF EXISTS `cargodet`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cargodet` (
  ...
  `idcampo` varchar(12) NOT NULL,
  `nombre` varchar(61) DEFAULT ' ',
  `grupo` varchar(6) DEFAULT ' ',
  `subgrupo` varchar(6) DEFAULT ' ',
  `proceso` double(2,0) NOT NULL DEFAULT '0',
  ...
  `seriales` text,
  `ubicacion` varchar(20) DEFAULT ' ',
  `almacenhas` varchar(2) DEFAULT ' ',
  ...
  PRIMARY KEY (`documento`,`codigo`,`idcampo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cargodet`
--

LOCK TABLES `cargodet` WRITE;
/*!40000 ALTER TABLE `cargodet` DISABLE KEYS */;
/*!40000 ALTER TABLE `cargodet` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-25 10:27:02
