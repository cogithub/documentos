...
--
-- Table structure for table `existenc`
--

DROP TABLE IF EXISTS `existenc`;
...
--
-- Dumping data for table `existenc`
--

LOCK TABLES `existenc` WRITE;
/*!40000 ALTER TABLE `existenc` DISABLE KEYS */;
/*!40000 ALTER TABLE `existenc` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-25 10:10:07
