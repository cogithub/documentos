...
--
-- Table structure for table `gastarmv`
--

DROP TABLE IF EXISTS `gastarmv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gastarmv` (
  ...
  `costounitorig` double(20,7) NOT NULL DEFAULT '0.0000000',
  ...
  `dsctoendmto` double(20,7) NOT NULL DEFAULT '0.0000000',
  `dsctoendprc` double(20,7) NOT NULL DEFAULT '0.0000000',
  ...
  `prcretencion` double(20,7) NOT NULL DEFAULT '0.0000000',
  ...
  `ordenam` double(5,0) NOT NULL DEFAULT '0',
  `cntentrega` double(20,7) NOT NULL DEFAULT '0.0000000',
  PRIMARY KEY (`tipodoc`,`documento`,`pid`,`codigo`,`proveedor`),
  KEY `codigoart` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gastarmv`
--

LOCK TABLES `gastarmv` WRITE;
/*!40000 ALTER TABLE `gastarmv` DISABLE KEYS */;
/*!40000 ALTER TABLE `gastarmv` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-25 10:30:55
