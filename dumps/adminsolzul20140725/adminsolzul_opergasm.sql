...
--
-- Table structure for table `opergasm`
--

DROP TABLE IF EXISTS `opergasm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opergasm` (
  ...
  PRIMARY KEY (`tipodoc`,`documento`,`recibo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `opergasm`
--

LOCK TABLES `opergasm` WRITE;
/*!40000 ALTER TABLE `opergasm` DISABLE KEYS */;
/*!40000 ALTER TABLE `opergasm` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-25 10:06:57
