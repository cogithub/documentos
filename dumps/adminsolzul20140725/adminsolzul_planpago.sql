...
CREATE TABLE `planpago` (
  ...
  `totaldoc` double(20,7) NOT NULL DEFAULT '0.0000000',
  `totpagos` double(20,7) NOT NULL DEFAULT '0.0000000',
  `totalret` double(20,7) NOT NULL DEFAULT '0.0000000',
  KEY `id_empresa` (`id_empresa`,`agencia`,`plan`,`tipodoc`,`documento`,`codprov`)
...
-- Dump completed on 2014-07-25 10:43:36
