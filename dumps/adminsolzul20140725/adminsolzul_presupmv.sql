...
--
-- Table structure for table `presupmv`
--

DROP TABLE IF EXISTS `presupmv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `presupmv` (
  ...
  PRIMARY KEY (`documento`,`placa`,`codigo`,`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `presupmv`
--

LOCK TABLES `presupmv` WRITE;
/*!40000 ALTER TABLE `presupmv` DISABLE KEYS */;
/*!40000 ALTER TABLE `presupmv` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-25 10:18:14
