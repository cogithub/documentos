...
CREATE TABLE `treserva` (
  ...
  `tire_des` varchar(40) NOT NULL DEFAULT ' ',
  PRIMARY KEY (`tire_cod`)
...
INSERT INTO `treserva` VALUES ('SOLZUL','001','001','NORMAL'),('SOLZUL','001','002','TELÉFONICA'),('SOLZUL','001','003','INTERNET');
...
-- Dump completed on 2014-07-25 10:47:50
